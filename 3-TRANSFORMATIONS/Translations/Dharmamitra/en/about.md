---
title: "1-SOURCES/Text/bo-ཟབ་ཏིག་སྒྲོལ་ཆོག.md — DharmaMitra zero-shot (english)"
...
| `bo-ཟབ་ཏིག་སྒྲོལ་ཆོག-en.md` | The rendered translation, block-ID aligned to the source. |
...
python3 4-SYSTEM/Skills/dharmamitra-translate/scripts/dm_translate.py \
  --source "1-SOURCES/Text/bo-ཟབ་ཏིག་སྒྲོལ་ཆོག.md" --lang english
```
